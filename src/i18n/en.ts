export const en = {
  ...
  pricing: {
    ...
    perYear: '/year',
    careBoundary: 'New pages, redesigns, new integrations and custom development are quoted separately.',
    plans: [
      {
        id: 'solo',
        name: 'Solo',
        ...
        tagline:
          'A custom professional website for independent professionals who need a strong online presence and an easy way for clients to get in touch.',
        bestFor: 'Consultants, therapists, coaches, freelancers and other independent professionals.',
        outcomes: [
      ...
      },
      {
        ...
        name: 'Essential',
        price: '€600',
        menuLine: 'For small businesses',
        tagline: 'A complete small-business website for businesses that need more space to present services, build trust and guide customers.',
        bestFor: 'Small businesses with several services that need a more complete and structured website.',
        outcomes: [
          'Present multiple services clearly',
          'Build more trust with stronger content and proof',
          'Guide visitors toward the right service or enquiry',
        ],
        includesPrevious: 'Everything in Solo, plus:',
        features: [
          'Up to 5 pages',
          'Dedicated service pages or sections',
          'Stronger copywriting support',
          'Testimonials, portfolio or gallery structure where relevant',
          'Local SEO setup',
        ...
        care: {
          name: 'Essential Care',
          price: '€240',
          includesPrevious: 'Everything in Solo Care, plus:',
          features: [
      ...
      },
      {
        ...
        name: 'Professional',
        price: '€900',
        menuLine: 'For more bookings and enquiries',
        tagline: 'A website built to help turn visitors into leads, bookings and customer enquiries.',
        bestFor:
          'Businesses that want their website to actively generate customer actions instead of only presenting information.',
        outcomes: [
          'Make it easier for visitors to book or enquire',
          'Turn key service pages into conversion-focused journeys',
          'See which services and traffic sources generate interest',
        ],
      ...
      },
      {
        ...
        name: 'Growth',
        price: '€1,300+',
        menuLine: 'For advanced growth needs',
        tagline: 'A custom website system for businesses that need advanced functionality, integrations, campaigns or more complex customer journeys.',
        priceNote: 'Final price depends on the functionality and integrations required.',
        bestFor: 'Businesses with campaigns, training, digital products, advanced integrations or custom workflows.',
        outcomes: [
          'Build more advanced lead, booking or sales journeys',
          'Connect tools and workflows around your business',
          'Add functionality beyond a standard business website',
        ],
        ...
        features: [
          ...
          'Advanced content management where relevant',
          'Advanced tracking',
          'Custom functionality',
        ],
        scopeNote:
          'More complex systems such as customer accounts, protected digital products, subscriptions or custom portals are scoped as part of the Growth project.',
        cta: 'Request a quote',
        ...
        care: {
          name: 'Growth Care',
          price: '€480',
          includesPrevious: 'Everything in Professional Care, plus:',
          features: [
