export const en = {
    ...
    plans: [
      {
        ...
        name: 'Solo',
        price: '€400',
        menuLine: 'Professional presence for one-person businesses',
        tagline:
          'A custom-designed professional website that gives independent professionals a credible online presence and a clear way for people to get in touch.',
        bestFor:
          'Independent professionals who need a polished website for their services, profile and contact details without complex business functionality.',
        outcomes: [
          'Build a professional and trustworthy online presence',
          'Present who you are and what you offer clearly',
          'Make it easy for potential clients to contact you',
          'Understand basic traffic and key contact actions',
        ],
        features: [
          '1 to 3 core pages',
      ...
      },
      {
        ...
        name: 'Essential',
        price: '€600',
        menuLine: 'For established small businesses',
        tagline: 'Build a complete small-business website that presents your services clearly and gives customers more reasons to choose you.',
        bestFor:
          'Small businesses with several services that need a more complete structure, stronger messaging and a better customer journey.',
        outcomes: [
          'Present multiple services in a clear structure',
          'Build stronger trust with a fuller business website',
          'Guide visitors toward the right service or enquiry',
          'Show proof such as testimonials, work or galleries where relevant',
          'Track important calls to action and enquiries',
        ],
        features: [
          'Up to 5 core pages',
          'Custom design built around your business',
          'Mobile optimisation',
          'Stronger copywriting support',
          'Dedicated service sections or pages',
          'Testimonials or gallery structure where relevant',
          'Contact and enquiry forms',
          'Local and basic SEO setup',
          'Google Analytics + Search Console',
          'Key CTA and enquiry tracking',
          'One simple integration where appropriate',
        ],
        cta: 'Start a project',
        action: 'start' as const,
        popular: false,
      ...
      },
      {
        ...
        name: 'Professional',
        price: '€900',
        menuLine: 'For businesses that want more bookings and enquiries',
        tagline: 'Turn your website into a customer-acquisition tool built around bookings, enquiries and measurable actions.',
        bestFor:
          'Businesses that want their website to actively generate leads, bookings and enquiries instead of simply presenting information.',
        outcomes: [
          'Turn service pages into focused enquiry and booking journeys',
          'Make it easier for visitors to take the next step',
          'Connect your booking system directly to the website',
          'Measure which services, pages and traffic sources generate interest',
          'Update important website content more easily',
          'Launch with stronger copy, calls to action and conversion structure',
        ],
        includesPrevious: 'Everything in Essential, plus:',
        features: [
          'More pages and dedicated service pages',
          'Full copywriting support',
          'Booking system integration',
          'Lead and booking conversion tracking',
          'Campaign and traffic-source tracking',
          'Stronger SEO structure',
          'CTA and enquiry-flow strategy',
          'Easy editing for key website content where appropriate',
          'Launch support and priority assistance',
        ],
        cta: 'Start a project',
        action: 'start' as const,
        popular: true,
      ...
      },
      {
        ...
        name: 'Growth',
        price: '€1,300+',
        menuLine: 'For businesses with advanced growth needs',
        tagline: 'Build a custom digital growth system around campaigns, leads, bookings, content and more complex business workflows.',
        bestFor:
          'Businesses that need campaign landing pages, advanced customer journeys, training or course content, custom integrations or business-specific workflows.',
        outcomes: [
          'Run campaigns with dedicated landing pages and funnels',
          'Build advanced lead, booking and conversion journeys',
          'Support courses, training or complex service structures',
          'Connect tools, systems and workflows around your business',
          'Measure funnels and custom conversion paths',
          'Add custom functionality that standard websites do not provide',
        ],
        includesPrevious: 'Everything in Professional, plus:',
        features: [
          'Campaign landing pages and funnels',
          'Course or training sections',
          'Advanced integrations',
          'Custom workflows and automations',
          'Advanced CMS and content structures where relevant',
          'Deeper SEO architecture',
          'Advanced funnel and conversion tracking',
          'Custom events and measurement',
          'Custom functionality built around your project',
        ],
        cta: 'Request a quote',
  ...
  hairBeauty: {
    ...
    features: [
      { title: 'Professional online presence', blurb: 'A site that matches the quality of your work.' },
      { title: 'Clear service presentation', blurb: 'Show exactly what you offer.' },
      { title: 'Galleries that sell', blurb: 'Fast, organised galleries built for mobile.' },
      { title: 'Booking integration', blurb: 'Connect Treatwell, Fresha, Booksy or your current system.' },
      { title: 'Google visibility foundation', blurb: 'Proper SEO and Google setup so people find you.' },
      { title: 'Made for mobile', blurb: 'Built phone-first, where most clients find you.' },
      { title: 'More enquiries', blurb: 'Clear prompts toward booking or getting in touch.' },
      { title: 'Ongoing website care', blurb: 'Kept online, secure and up to date.' },
    ],
    bookingTitle: 'Keep the booking system you already use',
    bookingCopy:
      'Treatwell, Fresha, Booksy or another platform: we connect your existing booking journey to your website, so there’s no new system to learn.',
