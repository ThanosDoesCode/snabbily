                  ...
                  <div className="pt-5 relative">
                    {plan.custom ? (
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        {plan.popular && (
                          <div className="inline-flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-2 border-green-500/40 rounded-full w-fit">
                            <span className="text-sm font-bold text-green-600 dark:text-green-400">
                              🎉 LAUNCH OFFER
                            </span>
                            <span className="text-sm font-bold text-green-600 dark:text-green-400">Save 2,000 SEK</span>
                          </div>
                        )}
                      </div>
                    )}
