...
const Pricing = () => {
  ...
  return <section className="py-40 bg-secondary" id="pricing">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-7xl mx-auto">
          ...
          animationDelay: `${index * 0.1}s`
              ...
              <CardContent className="pt-0">
                ...
                <Button className="w-full text-base py-6 font-semibold" variant={plan.popular ? "default" : "outline"} size="lg" onClick={scrollToContact}>
                  Get Started
                </Button>
              </CardContent>
            </Card>)}
