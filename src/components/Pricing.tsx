                    ...
                    {plan.custom ? (
                      ...
                      <>
                        ...
                        <div className="flex flex-col gap-2">
                          ...
                          {plan.popular && (
                            <div className="inline-flex items-center gap-1.5 md:gap-2 md:px-4 md:py-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-full w-fit px-[12px] py-[7px]">
