                  ...
                  <div className="pt-5 relative">
                    {plan.custom ? (
                      ...
                      <div className="flex flex-col gap-3">
                        ...
                        {plan.popular && (
                          <div className="inline-flex items-center gap-1 sm:gap-2 px-2 sm:px-4 py-1.5 sm:py-2.5 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-2 border-green-500/40 rounded-full w-fit text-center mx-auto sm:mx-0">
                            <span className="text-[10px] sm:text-xs md:text-sm font-bold text-green-600 dark:text-green-400 whitespace-nowrap">
                              🎉 LAUNCH OFFER
                            </span>
                            <span className="text-[10px] sm:text-xs md:text-sm font-bold text-green-600 dark:text-green-400 whitespace-nowrap">
                              Save 2,000 SEK
