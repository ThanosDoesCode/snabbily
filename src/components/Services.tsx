...
const Services = ({
  ...
  const services = [{
    ...
    features: ["Modern, AI-assisted design", "1–6 pages included", "Mobile-first & responsive", "Booking integration (any platform or simple form)", "SEO optimization", "Google Business setup", "Delivered in 3–4 days"]
  }, {
    icon: RefreshCw,
    title: "Monthly Maintenance",
    description: "Ongoing support and peace of mind",
    features: ["Reliable hosting included", "Security & software updates", "Booking system support", "Up to 3 monthly changes", "Ongoing technical support", "AI consultant based on your webpage"]
  }, {
    icon: Plus,
    title: "Add-ons",
